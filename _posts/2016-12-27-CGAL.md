...
Git is a distributed versioning manager. It has become the standard recently in the program developping community. It is easy to migrate, if need be, from SVN and Mercurial to Git. Platforms like [GitHub](https://github.com) and [GitLab](https://gitlab.com) make good ambassadors for Git.
